...
class SlidePageAnimation extends CustomTransitionPage<void> {
  SlidePageAnimation({required super.child, required GoRouterState state})
    : super(
        name: state.name,
        key: state.pageKey,
...
class ScalePageAnimation extends CustomTransitionPage<void> {
  ScalePageAnimation({required super.child, required GoRouterState state})
    : super(
        name: state.name,
        key: state.pageKey,
        arguments: state.extra,
...
class FadePageAnimation extends CustomTransitionPage<void> {
  FadePageAnimation({required super.child, required GoRouterState state})
    : super(
        name: state.name,
        key: state.pageKey,
        arguments: state.extra,
